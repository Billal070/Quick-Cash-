...
// ==========================================
// FIREBASE LOGIC & REFERRAL SYSTEM
// ==========================================
            ...
            if (startParam && startParam !== userData.userId) {
                try {
                    ...
                    if (referrerSnap.exists()) {
                        ...
                        // Add Reward to the person who invited them!
                        await updateDoc(referrerRef, {
                            balance: (refData.balance || 0) + REF_REWARD_AMOUNT,
                            referralCount: (refData.referralCount || 0) + 1,
                            totalIncome: (refData.totalIncome || 0) + REF_REWARD_AMOUNT
                        });
                    ...
                    console.error("Referral System Error:", refError);
                }
            }
...
window.joinTask = function() {
    ...
    if (btn.textContent === "JOIN") {
        tg.openLink("https://t.me/telegram");
